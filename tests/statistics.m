...
axis([0 100 0 100]);
axis 'autoy';
title('poczatkowy rozklad populacji N=5000');
...
axis([0 100 0 100]);
axis 'autoy';
title('rozklad populacji w 5 generacji N=5000');
xlabel('kod chromosomu');
ylabel('ilosc osobnikow');
...
axis([0 100 0 100]);
axis 'autoy';
title('rozklad populacji w 100 generacji N=5000');
xlabel('kod chromosomu');
ylabel('ilosc osobnikow');
...
title('srednie przystosowanie N=5000');
...
xlabel('numer generacji');
ylabel('entropia');
title('entropia populacji N=5000');
...
title('odchylenie standardowe N=5000');
